                ...
                <ul class="dropdown-menu userinfo arrow">
                    ...
                    <li class="userlinks">
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="../_controllers/controllervendeur.php?function=logout_vendeur">Sign Out <i class="pull-right fa fa-question-circle"></i></a></li>
    ...
    <div id="page-container">
        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li><a href="magasin.php"><i class="fa fa-th"></i> <span>Commande</span> </a></li>
