                    ...
                    <div class="product-boxlep">
                        ...
                        <div class="all-images-x">
                            ...
                            <div class="smallxo-images">
                                <img class=" active" src="<?= $article->image ?>" alt="">
                                <img class="" src="<?= $article->image2 ?>" alt="">
                                <img class="" src="<?= $article->image3 ?>" alt="">
                            </div>

                            <div class="main-images-x">
                                <img src="<?= $article->image ?>" alt="Image To Zoom" class="block__pic">
                        ...
                        <!--debut responsive vue de l'article je concidere comme nul(existe pas)-->
                            ...
                            <div class="magic_pop">
                                ...
                                <a href="#popbresp1" class="button">
                                    ...
                                    <div class="main-carousel">
                                        <div class="cell1"> <img class=" active" src="<?= $article->image ?>" alt="">
                                        </div>
                                        <div class="cell2"><img class="" src="<?= $article->image2 ?>" alt=""></div>
                                        <div class="cell3"><img class="" src="<?= $article->image3 ?>" alt=""></div>
                                    </div>
                                ...
                                <div id="popbresp1" class="overlatbig">
                                    ...
                                    <div class="popbresp">
                                        ...
                                        <div class="main-carousel">
                                            <div class="cell1"> <img class=" active" src="<?= $article->image ?>" alt=""></div>
                                            <div class="cell2"><img class="" src="<?= $article->image2 ?>" alt=""></div>
                                            <div class="cell3"><img class="" src="<?= $article->image3 ?>" alt=""></div>
                                        </div>
                    ...
                    <div class="texxt-box">
                        <div class="titles-articles">
                            ...
                            <div class="color-content">
                                ...
                                <div class="color-groups">
                                    ...
                                    <?php foreach (preg_split("/\,/", $article->color) as $coulor) : ?>
                        ...
                        <div class="size-container">
                            ...
                            <div class="sizes">
                                ...
                                <?php foreach (preg_split("/\,/", $article->size) as $sizes) : ?>
                                    <span class="size">
                                        <?= strtoupper($sizes)  ?>
                                    </span>
                                <?php endforeach; ?>
