                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div class="accordion-item-body">
                                                            <div class="accordion-item-body-content">
                                                                <p> Market Online est une plateforme numérique qui
                                                                    regroupe
                                                                    et fait la publicité de plusieurs magasins
                                                                    physiques.
                                                                <p> Cette plateforme permet aux marchés traditionnels de
                                                                    se
                                                                    digitaliser en augmentant le profit.</p>
                                                                <p>Toutes les prestations proposées par les vendeurs ne
                                                                    nécessitent pas d'échange physique.</p>
                                                        ...
                                                        <div class="accordion-item-body">
                                                            <div class="accordion-item-body-content">
                                                                <p>Pour pouvoir faire un achat sur Market Online il vous
                                                                    faut
                                                                    préalablement vous inscrire sur le site.</p>
                                                                <p>Après avoir choisi son article, rentrer en contact
                                                                    avec
                                                                    le vendeur pour savoir si la marchandise est
                                                                    toujours
                                                                    d’actualités.</p>
                                                                <p>Envoyer la marchandise vers le service livraison,
                                                                    acquittes vous des modalités de paiement.</p>
                                                        ...
                                                        <div class="accordion-item-body">
                                                            <div class="accordion-item-body-content">
                                                                <p>Lorsque vous passez une commande sur Market Online,
                                                                    vous n'avez
                                                                    pas besoin de transmettre vos coordonnées
                                                                    personnelles
                                                                    aux vendeurs.</p>
                                                                <p> votre argent est securisé par nos services jusqu’à
                                                                    ce
                                                                    que votre marchandise soit livré.</p>
                                                                <p>Il faut noter que Market Online vous garantit
                                                                    l’anonymat en
                                                                    sécurisant votre transaction et vous offre une
                                                                    livraison
                                                                    rapide.</p>
                                                        ...
                                                        <div class="accordion-item-body">
                                                            <div class="accordion-item-body-content">
                                                                <p>Pour devenir vendeur il faut necessairement avoir un
                                                                    magasin physique pour passer à l'étape de la
                                                                    creation du
                                                                    compte.</p>
                                                                <p>l'enregistrement sur le sitre nécéssite une
                                                                    pièce d'identité pour justifier l'appartenance du
                                                                    compte, une adresse pour justifier l'emplacement du
                                                                    magasin et un numéro de téléphone nécessaire dans
                                                                    les rensseignements.
                                                                </p>
                                                                <p>Apres avoir renseigner les champs vide
                                                                    vous êtes considérer comme un vendeur.</p>
