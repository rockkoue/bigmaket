                    ...
                    <div class="col"><br>
                        ...
                        <div class="Dispositions-box">
                            ...
                            <div class="dispo-market">
                                ...
                                <?php foreach ($dataavc as $recherchedata) : ?>
                                    <div class="cardp">
                                        <img src="<?= $recherchedata->logo_magasin ?>" class="card-img-top">
                                        <div class="card-body">

                                            <div class="detailsA">
                                                <p class="x__nowrap"><?= $recherchedata->nom_magasin ?></p>
                                            </div>
                                            <div class="positions">
                                                <span class="">
                                                    <h6><?= ' ' . (new vendeur())->Getville((int)$recherchedata->ville_magasin) ?>,<?= ' ' . (new vendeur())->Getcommune((int)$recherchedata->commune_magasin)?></h6>
                                                </span>
                                            </div>
