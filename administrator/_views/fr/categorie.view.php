        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <h3>Type de categorie concernant vos articles </h3>
                    <br>
                    <form class="form-horizontal" action="../_controllers/controllercategorie.php" id="formulaireID">
                        <input type="hidden" name="object" value="add">
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-3 control-label">Nom categorie</label>
                            <div class="col-sm-6">
